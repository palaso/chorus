...
namespace Chorus.merge.xml.generic
{
	...
	public class XmlMerger
	{
		...
		/// </summary>
		internal void MergeInner(XmlNode parent, ref XmlNode ours, XmlNode theirs, XmlNode ancestor)
		{
			SendMergeHeartbeat();
			_oursContext = ours;
			...
			{
				ImmutableElementMergeService.DoMerge(this, parent, ref ours, theirs, ancestor);
			...
			if (elementStrat.IsAtomic)
			{
				...
				MergeAtomicElementService.Run(this, parent, ref ours, theirs, ancestor);
				return;
			}
